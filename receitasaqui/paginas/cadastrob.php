...
<body>
			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" action="cadastrob.php" method="POST">
					...
					<div class="flex-col-c p-t-80">
						...
						<a href="http://localhost/projetosphp/receitasaqui/paginas/loginb.php" class="txt2">
							Fazer login
						</a>
					</div>
	...
	<script src="http://localhost/projetosphp/receitasaqui/script/validar-senha.js"></script>
